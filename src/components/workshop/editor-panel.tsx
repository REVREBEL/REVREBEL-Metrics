...
import type { TranspileError } from "@/lib/workshop/transpile";
import type { editor } from "monaco-editor";
import {
  MonacoJsxSyntaxHighlight,
  getWorker,
} from "monaco-jsx-syntax-highlight";
import pierreDarkJson from "@/lib/workshop/themes/pierre-dark.json";
import pierreLightJson from "@/lib/workshop/themes/pierre-light.json";
        ...
        <InputGroupAddon align="inline-end">
          ...
          >
            <HugeiconsIcon icon={IconStar}
              ...
              className="data-[favorite=true]:fill-primary data-[favorite=true]:text-primary"
            />
          </InputGroupButton>
        </InputGroupAddon>
      </InputGroup>
      ...
      <div className="flex h-10 shrink-0 items-center justify-between border-b border-border pr-3">
        <div className="flex h-full">
          <button
            ...
            className={`inline-flex h-full items-center px-3 text-xs font-medium leading-none transition-colors ${isComponentTab
